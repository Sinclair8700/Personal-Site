            ...
            @foreach ($projects as $project)
                <a href="/projects/{{ $project->slug }}">
                    <x-bubble class="max-w-full flex flex-col xs:flex-row h-full xs:aspect-[2/1] [&]:p-0">
                        <div class="peer peer-hover:w-0 order-2 xs:order-first w-full xs:w-1/2 px-6 py-4 flex flex-col min-h-0 transition-[width] duration-300">
                        ...
                        <div class="peer aspect-square w-full xs:w-1/2  ">
