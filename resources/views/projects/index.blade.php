        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            @foreach ($projects as $project)
                <a href="/projects/{{ $project->slug }}">
                    <x-bubble class="max-w-full flex flex-col xs:flex-row h-full xs:aspect-[2/1] xs:w-1/2 [&]:p-0 [&:has(.the-image:hover)_.the-text]:w-0 min-w-0">
                        <div class="the-text order-2 xs:order-first w-full xs:w-1/2 px-6 py-4 flex flex-col min-h-0 transition-[width] duration-300">
