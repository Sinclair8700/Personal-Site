<x-page :title="$title" :noindex="true">
    <x-content class="py-6">
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <x-bubble>
                <h3>Projects</h3>
                <p class="text-4xl font-semibold text-white">{{ $projectCount }}</p>
            </x-bubble>
            <x-bubble>
                <h3>Messages</h3>
                <p class="text-4xl font-semibold text-white">{{ $messageCount }}</p>
            </x-bubble>
            <x-bubble>
                <h3>Unique visitors</h3>
                <p class="text-4xl font-semibold text-white">{{ $uniqueVisitors }}</p>
            </x-bubble>
        </div>
